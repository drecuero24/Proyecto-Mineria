...
Aqui cambiamos la variable default porque en ek DAA hemos visto que sería bueno representarla correctamente. 1NO, 2 yes y unknow 0
```{r default, echo=FALSE}
attach(dataSet)
def_no=which(default=='no')
def_si=which(default=='yes')
